...
VALUES (1, 'admin', '$2y$12$paMOABEnYs2h3DDIVsPPUe5iZIX/CYU3YxzlWuzfdKNPcpkJArrdC');
...
INSERT INTO `commentaires` (`id`, `message`, `pseudo`, `date_creation`, `id_produit`)
VALUES (1, 'ceci est un commentaire de test', 'test', '2019-11-11 15:07:15', 1);
...
INSERT INTO `panier` (`id`, `id_user`, `statut`)
VALUES (1, 1, 1);
...
INSERT INTO `produits` (`id`, `nom`, `description`, `prix`, `logo`, `logo2`, `id_categorie`, `id_sous_categorie`,
                        `id_admin`, `confirme`)
VALUES (1, 'T-shirt blanc', 'Taille : M', 15.9, 'tshirt-blanc.png', 'default.png', 1, 1, 1, 1),
...
INSERT INTO `sous_categories` (`id`, `nom`, `id_categorie`, `id_admin`)
VALUES (1, 't-shirt', 1, 1),
       (2, 'pantalon', 1, 1),
       (3, 'pull', 1, 1),
       (4, 't-shirt', 2, 1),
       (5, 'pull', 2, 1),
...
INSERT INTO `users` (`id`, `nom`, `prenom`, `mail`, `password`, `rue`, `code_postal`, `ville`, `telephone`, `approuve`)
VALUES (1, 'testeur', 'testeur', 'test@gmail.com', '$2y$12$Jwdgr8ejHjsKUFrsQ4XVe.jbx9bxBPwnL7A4H1uUWfG7dwysjcBGu',
        'autre', 'autre', 'autre', '0623321122', 1);
