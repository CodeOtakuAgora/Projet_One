    ...
    <div style="width:500px;">
        ...
        <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
            ...
            <tr>
                ...
                <td><input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>"><input type="text"
                                                                                                             name="mail"
                                                                                                             class="txtField"
            ...
            <tr>
                ...
                <td><input type="password" name="password" class="txtField" value="<?php echo $row['password']; ?>">
                </td>
            </tr>
