<div class="content table-responsive">
    <table aria-describedby="mon panier" class="table">
        ...
        <tr>
            <td><img src="ressources/vetements/<?php echo $article->logo ?>"
                     alt="mon vêtement acheté" width=40 heigh=35>
            </td>
            ...
            <td name="validator">
                <a href="#" id="<?php echo $article->id ?>"
                   quantityValid="quantity<?php echo $article->id ?>">Valider</a>
            </td>
            <td>
        ...
        <tr>
            ...
            <!-- cela fera appel a plusieurs fonctions permettant -->
            <!-- d'effectuer la fonctionnalite -->
            <td onclick="payment()" style="text-align: center" colspan="3">
    ...
    <!-- on se met donc du côté client (visiteur de la page) -->
    <!-- et une fois qu'il y a une nouvelle quantité -->
    <!-- du produit qui à été modifié on met à jour le prix total -->
    ...
    <!-- d'effectuer la fonctionnalite de mise à jour de la quantité -->
    <!-- sachant que le but est de récupérer -->
    <!-- la valeur qui se trouve dans l'input est de la passer dans l'url -->
    <!-- afin qu'en php on puisse récupérer cette quantité -->
    <!-- temp d'éxécution du script : 3ms -->
