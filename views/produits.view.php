...
<?php foreach ($requeteSousCategories as $souscategoriesList) {
    ...
    <?php foreach ($products as $productsList) { ?>
        ...
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="ressources/vetements/<?php echo $productsList['logo']; ?>"
                 alt="mon vêtement" width="250px" height="250px">
            <div class="card-body">
                ...
                <a href="articles.php?id=<?php echo $productsList['id']; ?>" class="btn btn-primary">Ajouter au
                    panier</a>
            </div>
        </div>
