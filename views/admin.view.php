<div class="content">
    ...
    <div class="container">
        <h1 style="text-align: center">Espace administration
    ...
    <table style="margin: 0 auto;" border="10px" aria-describedby="mes éléments cachés">
        ...
        <tr>
            ...
            <?php foreach ($users as $m) { ?>
                <td>
                    <p style="text-align: center"><?php echo $m['id'] ?> : <?php echo $m['nom'] ?> (<?php echo $m['mail'] ?>
                        )<?php if ($m['approuve'] == 0) { ?>
                            - <a href="admin.php?type=users&approuve=<?php echo $m['id'] ?>">Confirmer</a><?php
                        } ?>
                            - <a href="admin.php?type=users&supprime=<?php echo $m['id'] ?>">Supprimer</a>
                    </p>
                </td>
            <?php } ?>
                ...
                <td>
                    <p>
                        <img src="ressources/vetements/<?php echo $c['logo']; ?>"
                             width="100" height="75" alt="picture 1">
                        <img src="ressources/vetements/<?php echo $c['logo2']; ?>"
                             width="100" height="75" alt="picture 2">
                        : <strong><?php echo $c['nom'] ?></strong>
                        : <?php echo $c['description'] ?> (<?php echo number_format($c['prix'], 2, '.', '') . ' € ' ?>
                        )<?php if ($c['confirme'] == 0) { ?>
                            - <a href="admin.php?type=produits&confirme=<?php echo $c['id'] ?>">Approuver</a><?php
                        } ?> -
                        <a href="admin.php?type=produits&supprime=<?php echo $c['id'] ?>">Supprimer</a>
                    </p>
                </td>
            <?php } ?>
